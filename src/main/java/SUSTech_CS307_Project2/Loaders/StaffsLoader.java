...
public class StaffsLoader {
    ...
    public static void loadFromFile(String RecordsCSV, int max) throws Exception {
        ...
        threadPool.execute(() ->{
            try {
                iCompanyManager(RecordsCSV,max, ConnectionManager.getDMConnection());
            } catch (Exception e) {
        ...
        threadPool.execute(() ->{
            try {
                iOfficer(RecordsCSV,max, ConnectionManager.getDMConnection());
            } catch (Exception e) {
                System.err.println(e);
            } finally {
                latch.countDown();
        ...
        threadPool.execute(() ->{
            try {
                iCourier(RecordsCSV,max, ConnectionManager.getDMConnection());
            } catch (Exception e) {
                System.err.println(e);
            } finally {
                latch.countDown();
        ...
        threadPool.execute(() ->{
            try {
                iSustcManager(RecordsCSV,max, ConnectionManager.getDMConnection());
            } catch (Exception e) {
                System.err.println(e);
            } finally {
                latch.countDown();
    ...
    public static void iCompanyManager (String filePath, int max,Connection con) throws Exception {
        int cnt;
        int MAXRECORD = max;
    ...
    public static void iCourier (String filePath, int max,Connection con) throws Exception {
        int cnt;
        int MAXRECORD = max;
        File csv = new File(filePath);
        csv.setReadable(true);
    ...
    public static void iOfficer (String filePath, int max,Connection con) throws Exception {
        int cnt;
        int MAXRECORD = max;
        File csv = new File(filePath);
        csv.setReadable(true);
    ...
    public static void iSustcManager (String filePath, int max,Connection con) throws Exception {
        int cnt;
        int MAXRECORD = max;
        File csv = new File(filePath);
        csv.setReadable(true);
